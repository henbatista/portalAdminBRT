    ...
    <div class="loginwrapper">
      <div class="lg-inner-column">
        <div class="left-column relative z-[1]">
          <section><img src="/assets/bg-birthday.jpg" /></section>
        </div>
        <section
          class="flex w-full sm:w-3/5 xl:w-4/12 lg:w-3/12 2xl justify-center items-center p-4"
        >
          <div class="right-column relative">
            <div class="inner-content h-full flex flex-col bg-white">
              <div class="auth-box h-full flex flex-col justify-center">
                <div class="mobile-logo text-center mb-10 lg:hidden block">
                  <img
                    src="../public/assets/logo_BRT_blue.png"
                    alt=""
                    class="mx-auto h-24 mb-5"
                  />
                </div>
                ...
                <div class="w-full max-w-sm">
                  <div class="text-center 2xl:mb-10 mb-4">
                    ...
                    <div class="text-slate-500 text-base">
                      Faça login para começar a usar o painel administrativo
                    </div>
                  </div>
