      ...
      <div class="pt-1">
        ...
        <div id="attach-contract" class="mt-6 flex flex-col gap-2">
          ...
          <div class="relative w-full flex">
            ...
            <label
              ...
              t text-sm pl-8  placeholder:font-light focus:border-slate-600 cursor-pointer bg-slate-100 text-slate-900 text-center px-4 py-2 rounded-l-lg "
            >
            <Icon class="-mt-0.5 mr-3" :icon="icons.sendFileinput" />  Selecionar Arquivo    
            </label>
            <span id="file_name" class="p-2 border w-7/12 h-10  flex-none cursor-pointer border-l px-4 border-slate-200   inline-flex items-center  text-slate-600 text-base rounded-tr rounded-br font-normal">{{ fileNamesNew.docContract1 }}</span>
          </div>
        ...
        <div id="attach-address" class="mt-6 flex flex-col gap-2">
          ...
          <div class="relative w-full flex">
            ...
            <span id="file_name_2" class="p-2 border  w-7/12 h-10  flex-none cursor-pointer border-l px-4 border-slate-200   inline-flex items-center  text-slate-600 text-base rounded-tr rounded-br font-normal">{{ fileNamesNew.docAddress1 }}</span>
          </div>
          <p class="mt-1 text-xs">Enviar um comprovante com data de vencimento atual (deste mês ou do mês passado).</p>
                ...
                <div id="attach-owner-3" class="mt-4 flex flex-col gap-2">
                  ...
                  <div class="relative w-full flex">
                    ...
                    <span id="file_name_5" class="p-2 border  w-7/12 h-10  flex-none cursor-pointer border-l px-4 border-slate-200   inline-flex items-center  text-slate-600 text-base rounded-tr rounded-br font-normal">{{ fileNamesNew.docLogo }}</span>
                  </div>
     ...
     ></div>
        ...
        <div id="attach-owner" class="mt-4 flex flex-col gap-2">
          ...
          <div class="relative w-full flex">
            ...
            <label
              ...
              class="w-full h-[40px] file-control flex items-center  rounded-sm  g-white transition duration-300 ease-in-out border border-slate-200 focus:ring-0  focus:outline-none  
              t text-sm  placeholder:font-light focus:border-slate-600 cursor-pointer bg-slate-100 text-slate-900 text-center px-4 py-2 rounded-l-lg"
            >
            <Icon class="-mt-0.5 mr-3" :icon="icons.sendFileinput" />  Selecionar Arquivo
            </label>
            <span id="file_name_3" class="p-2 border  w-7/12 h-10  flex-none cursor-pointer border-l px-4 border-slate-200   inline-flex items-center  text-slate-600 text-base rounded-tr rounded-br font-normal">{{ fileNamesNew.docSocio1 }}</span>
          </div>
        ...
        <div id="attach-owner" class="mt-4 flex flex-col gap-2">
          ...
          <div class="relative w-full flex">
            ...
            <span id="file_name_3"  class="p-2 border  w-7/12 h-10  flex-none cursor-pointer border-l px-4 border-slate-200   inline-flex items-center  text-slate-600 text-base rounded-tr rounded-br font-normal">{{ fileNamesNew.docSocio1verso }}</span>
          </div>
          <p class="mt-1 text-xs">Enviar uma foto do documento original ou autenticado.</p>
        </div>
        ...
        <div id="attach-owner" class="mt-1 flex flex-col gap-2">
          ...
          <div class="relative w-full flex">
            ...
            <span id="file_name_3" class="p-2 border  w-7/12 h-10  flex-none cursor-pointer border-l px-4 border-slate-200   inline-flex items-center  text-slate-600 text-base rounded-tr rounded-br font-normal">{{ fileNamesNew.docSocio1address }}</span>
          </div>
          <p class="mt-1 text-xs">Enviar um comprovante com data de vencimento atual (deste mês ou do mês passado).</p>
        </div>
      ...
      ></div>
        ...
        <div id="attach-owner-2" class="mt-1 flex flex-col gap-2">
          ...
          <div class="relative w-full flex">
            ...
            <span id="file_name_4" class="p-2 border  w-7/12 h-10  flex-none cursor-pointer border-l px-4 border-slate-200   inline-flex items-center  text-slate-600 text-base rounded-tr rounded-br font-normal">{{ fileNamesNew.docSocio2 }}</span>
          </div>
          <p class="mt-1 text-xs">Enviar uma foto do documento original ou autenticado.</p>
        </div>
        ...
        <div id="attach-owner-2" class="mt-1 flex flex-col gap-2">
          ...
          <div class="relative w-full flex">
            ...
            <span id="file_name_4" class="p-2 border  w-7/12 h-10  flex-none cursor-pointer border-l px-4 border-slate-200   inline-flex items-center  text-slate-600 text-base rounded-tr rounded-br font-normal">{{ fileNamesNew.docSocio2verso }}</span>
          </div>
          <p class="mt-1 text-xs">Enviar uma foto do documento original ou autenticado.</p>
        </div>
        ...
        <div id="attach-owner-2" class="mt-1 flex flex-col gap-2">
          ...
          <div class="relative w-full flex">
            ...
            <span id="file_name_4" class="p-2 border  w-7/12 h-10  flex-none cursor-pointer border-l px-4 border-slate-200   inline-flex items-center  text-slate-600 text-base rounded-tr rounded-br font-normal">{{ fileNamesNew.docSocio2address }}</span>
          </div>
          <p class="mt-1 text-xs">Enviar um comprovante com data de vencimento atual (deste mês ou do mês passado).</p>
        </div>
        </div>
      ...
      ></div>
        ...
        <div id="attach-owner-3" class="mt-4 flex flex-col gap-2">
          ...
          <div class="relative w-full flex">
            ...
            <span id="file_name_5" class=" border  w-64 h-10  flex-none cursor-pointer border-l px-4 border-slate-200   inline-flex items-center  text-slate-600 text-base rounded-tr rounded-br font-normal">{{ fileNamesNew.docSocio3 }}</span>
          </div>
          <p class="mt-1 text-xs">Enviar uma foto do documento original ou autenticado.</p>
        </div>
        ...
        <div id="attach-owner-3" class="mt-4 flex flex-col gap-2">
          ...
          <div class="relative w-full flex">
            ...
            <span id="file_name_5" class="p-2 border  w-64 h-10  flex-none cursor-pointer border-l px-4 border-slate-200   inline-flex items-center  text-slate-600 text-base rounded-tr rounded-br font-normal">{{ fileNamesNew.docSocio3verso }}</span>
          </div>
          <p class="mt-1 text-xs">Enviar uma foto do documento original ou autenticado.</p>
        </div>
        ...
        <div id="attach-owner-3" class="mt-4 flex flex-col gap-2">
          ...
          <div class="relative w-full flex">
            ...
            <span id="file_name_5" class="p-2 border  w-7/12 h-10  flex-none cursor-pointer border-l px-4 border-slate-200   inline-flex items-center  text-slate-600 text-base rounded-tr rounded-br font-normal">{{ fileNamesNew.docSocio3address }}</span>
          </div>
          <p class="mt-1 text-xs">Enviar um comprovante com data de vencimento atual (deste mês ou do mês passado).</p>
        </div>
        </div>
