...
<template>
  <ModalConfirmation
    title="Deletar Banco"
    :deleteFunction="bankStore.deleteBank"
  />
  <div class="px-4">
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto mb-3">
        <div class="flex items-center">
          <img
          src="../../public/assets/bank.gif"
          alt="Ícone de envio"
          class="w-10 h-10 mr-2"
          
        />
        <h1 class="text-xl font-semibold text-gray-900 -mb-0">Bancos</h1>
        </div>
        <p class="mt-2 text-sm text-gray-700">
          Adicione, Remova ou Edite um Banco.
        </p>
      </div>
    ...
    >
      <table class="min-w-full divide-y shadow-lg mb-10 divide-gray-300">
        ...
        <tbody>
          <tr v-for="(bank, bankIdx) in props.banks" :key="bankIdx">
            <td
              :class="[
                bankIdx === 0 ? '' : 'border-t border-gray-200',
            ...
            >
              <button
                @click="
                  ...
                  bankStore.idDeleteOrUpdate = bank.id;
                "
                class="text-red-600"
              >
                <svg
              ...
              <button
                @click="
                  ...
                  sidebarStore.currentAction = 'Banks';
                  bankStore.idDeleteOrUpdate = bank.id;
                  bankStore.name = bank.name;
                  bankStore.bankNumber = bank.bank_number;
                "
                class="text-lime-600"
              >
                <svg
