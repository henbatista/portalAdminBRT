    ...
    <div class="mt-1">
      ...
      <div class="mx-5">
          ...
          <div class="grid xl:grid-cols-2 grid-cols-1 gap-5">
            ...
            <div >
              <label
                class="flex-0 text-sm md:w-[100px] w-[60px]"
              >
                Nome</label
              >
          ...
          <div class="grid xl:grid-cols-2 grid-cols-1 mt-4 gap-5">
            <AutoCompleteTenant :tenantId="user.tenant_id" :updateTenantId="updateTenantId" />
            <div >
          ...
          <div class="grid xl:grid-cols-1 grid-cols-">
            <div class="justify-self-end xl:mt-0 mt-4">
              ...
              >
                <div v-if="!userStore.isLoading" class="flex justify-center gap-5 items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
                  ...
                  <span v-if="userStore.idDeleteOrUpdate === ''">ADICIONAR USUÁRIO</span
